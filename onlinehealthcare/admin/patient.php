...
<html lang = "eng">
	<head>
		<title>ETHA Healthcare Tracking Systems</title>
		<meta charset = "utf-8" />
...
<body>
	<div class = "navbar navbar-default navbar-fixed-top">
		<img src = "../images/logo.jpeg" style = "float:left;" height = "55px;"  /><label class = "navbar-brand">Healthcare Tracking Systems</label>
			<?php
