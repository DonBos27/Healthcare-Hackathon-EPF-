...
<html lang = "eng">
	<head>
		<title>Healthcare Tracking System</title>
		<meta charset = "utf-8" />
...
<body>
	<div class = "navbar navbar-default">
		<img src = "../images/logo.jpeg" style = "float:left;" height = "55px" /><label class = "navbar-brand">Healthcare Tracking System</label>
	</div>
	...
	<div id = "footer">
		<label class = "footer-title">&copy; Copyright ETHA 2022</label>
	</div>
</body>
<?php
	include("script.php");
